...
type AccessMenuPGRepository struct {
	db *sql.DB
}

func NewAccessMenuPGRepository(db *sql.DB) *AccessMenuPGRepository {
	return &AccessMenuPGRepository{db: db}
}

func (r *AccessMenuPGRepository) ListMenus(ctx context.Context) ([]domain.AccessMenu, error) {
...
func (r *AccessMenuPGRepository) ListRoleAccess(ctx context.Context) ([]domain.RoleAccessConfig, error) {
...
func (r *AccessMenuPGRepository) UpdateRoleAccess(ctx context.Context, role string, menuKey string, canAccess bool) error {
...
var _ outbound.AccessMenuRepository = (*AccessMenuPGRepository)(nil)
